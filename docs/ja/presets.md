...
| 機能 | minimal | default | technical |
|------|---------|---------|-----------|
| **フォントファミリー** | セリフ | セリフ | サンセリフ |
| **基本サイズ** | 11pt | 11pt | 10pt |
| **カラー** | 白黒 | ネイビー/ブルー/グレー | ダーク/ブルー |
| **H1枠線** | なし | 下 | 下 |
| **コードブロック** | グレー背景 | グレー背景 | グレー背景+枠線 |
| **引用ブロック** | 左枠線 | 左枠線+背景 | 左枠線+背景 |
